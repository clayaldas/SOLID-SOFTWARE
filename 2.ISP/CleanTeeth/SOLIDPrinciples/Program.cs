...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        //var notification = new EmailNotificationService();/MODIFICADO
        //SmptpEmailService emailService = new SmptpEmailService();
        //var emailService = new SmptpEmailService();//MODIFICAR
        SendGridEmailNotificationService emailService = 
            new SendGridEmailNotificationService();

        TwilioSmsService smsService = new TwilioSmsService();//NUEVO
